...
async function loadQuestions() {
  try {
    ...
    state.strategyQuestions = data.layer_2_strategies.questions;
    state.valueQuestions = data.layer_3_values.questions;
...
function startNewJourney() {
  ...
  state.retryCount = 0;
  state.majorsResult = null; state.branchesResult = null;
  saveSession();
  render();
}
...
// ==================== DISPLAY RESULTS (با نمایش شاخص‌ها) ====================
